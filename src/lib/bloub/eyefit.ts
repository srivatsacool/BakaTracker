/*
 * Vendored from Bloub (https://github.com/jeremy-prt/bloub) src/bot/eyefit.ts
 ...
 * images par seconde â€” la derive du regard, le pointeur, l'expression en cours de
 ...
 * qui va du contour vers le segment â€” le sens qui degage.
 *
 ...
 * celles qui mettaient le visage a l'echelle rapetissaient les yeux â€” visiblement.
 *
 ...
 * fait que garder son meilleur essai â€” passer ses tours de 40 a 18 suffisait a faire
...
function resous(epreuves: Epreuve[]): { x: number; y: number } {
   ...
   * en plus de n'etre pas plus serree que sur le profil d'origine â€” sans cette seconde
 ...
 * paraissait plus sur â€” un decalage constant ne peut pas bouger quand l'expression change
 * â€” mais il est intenable : sur une capsule, `neutre` a les yeux hauts et demande a
 ...
 * declinent par expression â€” les trois autres etats a corps de base ont un visage releve
 ...
 * stabilite. Un profil inconnu, ou `null`, ne corrige rien â€” l'API accepte n'importe quel
 ...
 * de boule â€” le moteur le remet a son echelle.
 *
