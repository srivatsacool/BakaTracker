/*
 * Vendored from Bloub (https://github.com/jeremy-prt/bloub) src/bot/repere.ts
 ...
 * `BloubBot.vue`, donc hors d'atteinte â€” un `<script setup>` n'exporte rien â€” et
 ...
 * a 1,4 fois le rayon, soit 140. Rien ne les borne au runtime â€” c'est le reglage a la main
