  ...
  return (
    <div className="max-w-6xl mx-auto flex flex-col gap-6">
      ...
      <section className="cabinet cabinet--off" style={{ '--marquee-color': 'var(--arcade-green)' } as React.CSSProperties}>
        <div className="cabinet-marquee">
          <span className="cabinet-led" aria-hidden="true" />
          <span className="cabinet-marquee-title">Streak leaderboard</span>
          <span className="ml-auto font-mono text-[9px]" style={{ color: 'var(--arcade-paper-muted)' }} aria-hidden="true">best-ever · current</span>
        </div>
