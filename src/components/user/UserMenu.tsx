    ...
    <div className="relative inline-block text-left" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 bottom-11 md:bottom-auto md:top-11 z-[100] w-64 bg-white border-3 border-black rounded-lg p-3.5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-black animate-fade-in flex flex-col gap-2.5">
          ...
          <button
            onClick={() => logout()}
            className="flex items-center justify-center gap-2 w-full text-center px-3 py-2 text-xs font-black font-mono text-[#FF5C5C] hover:bg-[#FF5C5C]/10 border-2 border-black rounded-md transition cursor-pointer shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[0.5px] hover:translate-y-[0.5px] active:translate-x-[1px] active:translate-y-[1px]"
          >
