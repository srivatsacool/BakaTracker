...
> **Fork notice (Phase 1).** This repository is a fork of
> [Bloub](https://github.com/jeremy-prt/bloub) (MIT © 2026 Jérémy Perret),
> established as the standalone foundation for the **Bakasur** character /
> animation UI system. Upstream code is preserved verbatim (see `LICENSE` and
> `docs/ORIGINAL-LICENSE.md`); the upstream MIT licence covers the code, not
> the design it imitates, and this project is not affiliated with x.ai. New
> Bakasur artwork, identity and docs land incrementally from Phase 2 onward —
> see `docs/EXTRACTION_PLAN.md`, `docs/ARCHITECTURE.md` and
> `docs/BAKASUR-DESIGN.md`. Original Bloub documentation follows, unchanged.
