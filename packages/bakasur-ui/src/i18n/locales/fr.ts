...
export default {
  ...
  lab: {
    ...
    timeline: 'Montage',
    inspector: 'Configuration résolue',
    preview: 'Aperçu',
    live: 'Direct',
    frozen: 'Image figée',
    compare: 'Comparer',
    ...
    undo: 'Annuler',
    redo: 'Rétablir',
    addStep: 'Ajouter un plan',
    removeStep: 'Retirer',
    valid: 'Modèle valide',
    saveBlocked: 'Enregistrement impossible : le modèle est invalide.',
    fixedFace:
      'Ce véhicule impose son visage : le remplacement choisi reste sans effet visible.',
    ...
    duplicate: 'Dupliquer',
    saveAs: 'Enregistrer comme nouveau modèle',
    userModels: 'Mes modèles',
    selected: 'Choisi',
    resolved: 'Résolu',
    reason: 'Motif'
  },
  ...
  scene: {
    ...
    reset: 'Réinitialiser',
    loop: 'Boucle',
    scrub: 'Temps de scène',
    time: 'Lecture',
    viewport: 'Fenêtre',
    inspector: 'Inspecteur de scène',
    actorTheme: 'Teinte acteur',
    camera: 'Caméra',
    effects: 'Effets',
    dialogue: 'Dialogue',
    noDialogue: 'Sans dialogue',
    next: 'Réplique suivante',
    prev: 'Réplique précédente'
  }
}
