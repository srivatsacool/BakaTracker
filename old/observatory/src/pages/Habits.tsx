    ...
    <div className="max-w-4xl mx-auto flex flex-col gap-6 relative">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 z-10">
        ...
        <div className="flex items-center gap-2">
          {/* View toggle */}
          <div className="flex rounded-lg overflow-hidden" style={{ border: '1px solid rgba(242,242,242,0.12)' }} role="group" aria-label="View mode">
            <button
              type="button"
              ...
              <div className="cabinet-screen !p-4 grid grid-cols-1 sm:grid-cols-5 gap-3">
                {statConfig.map(stat => (
                  <div key={stat.name} className="flex flex-col gap-1.5">
                    ...
                    <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(242,242,242,0.08)' }}>
            ...
            {habits.map(habit => {
              ...
              return (
                <div key={habit.id} className="cabinet cabinet--playing" style={{ '--marquee-color': 'var(--arcade-green)' } as React.CSSProperties}>
                  <div className="cabinet-marquee">
                    <span className="cabinet-led" aria-hidden="true" />
                    <span className="cabinet-marquee-title">{habit.icon} {habit.name}</span>
                    <span className={`ml-auto font-mono text-[10px] chip ${isCompleted ? 'chip--teal' : ''}`}>
                      🔥 {streak} streak
                    </span>
                  </div>
                  <div className="cabinet-screen !p-4">
                    ...
                    {/* Week strip */}
                    <div className="mt-3 pt-3 flex items-end gap-1.5" style={{ borderTop: '1px solid rgba(242,242,242,0.07)' }} aria-label="Last 5 days">
                      {last5.map(day => {
                        ...
                        return (
                          <button
                            ...
                            style={{ background: done ? 'rgba(61,220,132,0.1)' : 'rgba(242,242,242,0.03)', border: `1px solid ${done ? 'rgba(61,220,132,0.3)' : 'rgba(242,242,242,0.07)'}` }}
              ...
              {daysInMonth.map(dateStr => {
                ...
                return (
                  <div
                    ...
                    style={{
                      background: pct >= 80 ? 'rgba(61,220,132,0.25)' : pct >= 40 ? 'rgba(111, 91, 216,0.18)' : pct > 0 ? 'rgba(63,123,255,0.14)' : 'rgba(242,242,242,0.03)',
                      border: `1px solid ${isToday ? 'rgba(111, 91, 216,0.5)' : 'rgba(242,242,242,0.06)'}`,
                      boxShadow: isToday ? '0 0 10px rgba(111, 91, 216,0.25)' : 'none',
