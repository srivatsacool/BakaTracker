...
export const FirstRunWizard: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[2000] bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
      <div className="w-full max-w-lg cabinet cabinet--playing overflow-hidden" style={{ '--marquee-color': 'var(--arcade-gold)' } as React.CSSProperties}>

        {/* Progress bar — the XP track */}
        <div className="h-1.5" style={{ background: 'rgba(242,242,242,0.08)' }}>
          <div
            className="h-full transition-all duration-500"
            style={{ width: `${(step / 4) * 100}%`, background: 'linear-gradient(90deg, var(--arcade-gold-deep), var(--arcade-gold))', boxShadow: '0 0 8px rgba(111, 91, 216,0.5)' }}
          />
        </div>
        ...
        <div className="flex items-center justify-between px-5 py-3" style={{ borderBottom: '1px solid rgba(242,242,242,0.1)', background: 'rgba(242,242,242,0.03)' }}>
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: 'rgba(111, 91, 216,0.15)', border: '1px solid rgba(111, 91, 216,0.4)' }}>
              <Sparkles className="w-4 h-4" style={{ color: 'var(--arcade-gold)' }} aria-hidden="true" />
            </div>
            <span className="font-bold text-sm" style={{ color: 'var(--arcade-paper)' }}>BakaTracker Setup</span>
          </div>
